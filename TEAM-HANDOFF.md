...
The research and signal-reconciliation stage is complete. Two downstream packages remain: `forecasting` and `workbook_generator`. The top-level runner already calls their required interfaces.
